...
| `@sefo/nodzimo-ui` | npm package metadata and the sibling `../nodzimo-ui` repo when present                                 | Public exports only: `.`, `./client`, `./styles.css`; package exports, compiled CSS, React Compiler compatibility, Turbopack resolution. Do not deep-import internals.                                                   |
...
| `@biomejs/biome`              | https://github.com/biomejs/biome, https://biomejs.dev                                                                             | Formatter/linter rule changes, Tailwind class sorting, CSS parser support, JSON strictness, config schema changes.     |
