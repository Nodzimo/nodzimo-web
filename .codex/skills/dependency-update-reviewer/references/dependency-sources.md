...
| `@nodzimo/nodzimo-ui` | npm package metadata and the sibling `../nodzimo-ui` repo when present                                 | Public exports only: `.`, `./client`, `./styles.css`; package exports, compiled CSS, React Compiler compatibility, Turbopack resolution. Do not deep-import internals.                                                   |
